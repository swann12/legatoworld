    ...
    <Shell hideNav>
      <div className="min-h-dvh bg-paper text-dusk pb-12">
        ...
        <div className="px-5 mt-8 no-print">
          <button onClick={() => window.print()} className="w-full rounded-[14px] border border-dusk/10 px-5 py-4 font-serif italic text-[15px] text-dusk hover:bg-dusk/5 transition-colors">
