...
const DICT: Dict = {
  ...
  "home.parler":   { fr: "Une présence", en: "A presence" },
  "home.parlerSub":{ fr: "Parler à voix basse.", en: "Speak softly." },
  "home.parlerBody":{ fr: "Quelqu'un qui écoute, sans rien attendre.", en: "Someone listening, without expectation." },
  "home.enter":    { fr: "Entrer", en: "Enter" },
  "home.practical":{ fr: "Démarches", en: "Steps" },
  "home.practicalSub":{ fr: "Une chose à la fois.", en: "One thing at a time." },
  "home.practicalAlways":{ fr: "Toujours là, à votre rythme.", en: "Always here, at your pace." },
  "home.journal":  { fr: "Journal", en: "Journal" },
  "home.journalSub":{ fr: "Une pensée à déposer.", en: "A thought to set down." },
  "home.nowords":  { fr: "Sans mots", en: "Without words" },
  "home.nowordsSub":{ fr: "Un son, une lumière, un souffle.", en: "A sound, a light, a breath." },
  "home.wishes":   { fr: "Mes volontés", en: "My wishes" },
  "home.wishesSub":{ fr: "Ce que vous aimeriez, plus tard.", en: "What you would wish, later." },
  "home.inspiration":{ fr: "Pour un proche", en: "For a loved one" },
  "home.inspirationSub":{ fr: "Des gestes qui lui ressemblent.", en: "Gestures that look like them." },
