      ...
      {options.map((o) => {
        ...
        return (
          <button
            ...
            style={{
              borderColor: on
                ? "color-mix(in oklab, var(--bordeaux) 35%, transparent)"
                : "color-mix(in oklab, var(--dusk) 15%, transparent)",
              background: on ? "var(--blush)" : "transparent",
              color: on ? "var(--bordeaux)" : "color-mix(in oklab, var(--dusk) 70%, transparent)",
            }}
          >
            {o.label}
          </button>
